      ...
      function compareTwoStrings(e, n) {
        ...
        for (var t = new Map(), r = 0; r < e.length - 1; r++) {
          var i = e.substring(r, r + 2),
            o = t.has(i) ? t.get(i) + 1 : 1;
          t.set(i, o);
        }
        for (var a = 0, c = 0; c < n.length - 1; c++) {
          var A = n.substring(c, c + 2),
            s = t.has(A) ? t.get(A) : 0;
          s > 0 && (t.set(A, s - 1), a++);
        }
        return (2 * a) / (e.length + n.length - 2);
      }
      e.exports = {
        ...
        findBestMatch: function (e, n) {
          ...
          for (var t = [], r = 0, i = 0; i < n.length; i++) {
            ...
            t.push({ target: o, rating: a }), a > t[r].rating && (r = i);
          }
          var c = t[r];
          return { ratings: t, bestMatch: c, bestMatchIndex: r };
        },
      };
    },
    function (e, n, t) {
      ...
      var i = t(0),
        o = "style='padding: 0;border: none;background: none;cursor: pointer;'",
        a = function App(e) {
          var n = this;
          !(function (e, n) {
            if (!(e instanceof n))
            ...
            _defineProperty(this, "configureRecognition", function () {
              ...
              (n.recognition.onresult = function (n) {
                var r = n.results.length - 1,
                  o = n.results[r][0].transcript.trim(),
                  a = t(o),
                  c = "";
                if (void 0 !== a)
                ...
                if (void 0 !== a && void 0 !== a.type && "action" === a.type) {
                  var d,
                    p = _createForOfIteratorHelper(a.phrases);
                  try {
                    for (p.s(); !(d = p.n()).done; ) {
                      var l = d.value;
                      o = o.replace(l, "");
                  ...
                  var B,
                    h = _createForOfIteratorHelper(
                      document.querySelectorAll("[og-intent='" + a.name + "']")
                    );
                  try {
                    for (h.s(); !(B = h.n()).done; ) {
                      var m = B.value;
            ...
            _defineProperty(this, "addMicrophoneElement", function () {
              ...
              (e.innerHTML =
                "<div class='the_activeintent' style='position: fixed;bottom: 5%;right: 5%;'><button id='microphone' " +
                o +
                ">" +
                r +
                "</button></div>"),
                (e.innerHTML =
                  '<div class="the_activeintent" style="position: fixed;bottom: 5%;right: 5%;"><div style="display:flex;color: #515151;align-items: center;"><div class="the_activeintent_permission the_activeintent_display_none"style="background: #EAEEF5;padding: 18px;border-radius: 13px;margin-right: 45px;bottom: 25px;">Enable permissions on <br> the upper left of your <br> browser window</div><div class="the_activeintent_listening the_activeintent_display_none"style="background: #EAEEF5;padding: 18px;border-radius: 13px;margin-right: 45px;">Listening . . .</div><div><button id="microphone" style="padding: 0;border: none;background: none;cursor: pointer;">' +
                  r +
                  "</button></div></div></div>"),
