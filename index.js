          ...
          !(function (e, t) {
            ...
            _defineProperty(this, "usingSDKRequest", function () {
              ...
              (e.onreadystatechange = function () {
                4 === e.readyState &&
                  "SUCCESS" === JSON.parse(e.response).status &&
                  (t.recognition &&
                ...
                e.open(
                  "GET",
                  "https://theactiveintent.com/api/v1/customer/using?hostname="
                    .concat("theactiveintent.com", "&activationKey=")
                    .concat(t.activationKey),
                  !0
                ),
                e.send();
            }),
            ...
            _defineProperty(this, "addMicrophoneElement", function () {
              ...
              (e.innerHTML =
                '<div class="the_activeintent" style="position: fixed;bottom: 5%;right: 2%;"><div style="display:flex;color: #515151;align-items: center;"><div style="position: absolute;right: 95%;"><div class="the_activeintent_permission"style="background: #EAEEF5;padding: 18px;border-radius: 13px;margin-right: 45px;position: relative;bottom: 40px;width: 198px;outline: none;display:none">Enable permissions on the upper left of your browser window<div style="position: absolute;right: -35px;bottom: 0;"><svg xmlns="http://www.w3.org/2000/svg" width="69" height="20" viewBox="0 0 69 20">              <path id="Polygon_1" data-name="Polygon 1" d="M34.5,0,69,20H0Z" fill="#eaeef5" />            </svg> </div></div><div class="the_activeintent_listening"style="background: #EAEEF5;padding: 18px;border-radius: 13px;margin-right: 10px;width: 198px;outline: none;display:none">Listening<span class="the_activeintent_int" style="padding-left:5px">.</span></div></div><div><button id="microphone" style="padding: 0;border: none;background: none;cursor: pointer;outline: none;display:flex;align-items:center"><img src="https://i.ibb.co/SnsCnd6/Group-2.png" style="position:absolute;right: 9px"/><img class="the_activeintent_image" src="https://i.ibb.co/9rW6Wrf/Frame3.gif" width="89px" style="opacity:0"  /></button></div></div></div>'),
