  ...
  return (function (e) {
    ...
    function (e, n) {
      function compareTwoStrings(e, n) {
        ...
        for (var t = new Map(), i = 0; i < e.length - 1; i++) {
          var r = e.substring(i, i + 2),
            o = t.has(r) ? t.get(r) + 1 : 1;
          t.set(r, o);
        }
        for (var a = 0, c = 0; c < n.length - 1; c++) {
          var s = n.substring(c, c + 2),
            A = t.has(s) ? t.get(s) : 0;
          A > 0 && (t.set(s, A - 1), a++);
        }
      ...
      e.exports = {
        ...
        findBestMatch: function (e, n) {
          ...
          for (var t = [], i = 0, r = 0; r < n.length; r++) {
            var o = n[r],
              a = compareTwoStrings(e, o);
            t.push({ target: o, rating: a }), a > t[i].rating && (i = r);
          }
          var c = t[i];
          return { ratings: t, bestMatch: c, bestMatchIndex: i };
        },
      };
    },
    function (e, n, t) {
        ...
        o = function App(e) {
          ...
          !(function (e, n) {
            ...
            _defineProperty(this, "findTheIntent", function (e) {
              var t,
                i = _createForOfIteratorHelper(n.intents);
              try {
                for (i.s(); !(t = i.n()).done; ) {
                  var r = t.value;
              ...
              (n.recognition.onstart = function () {
                ...
                (n.recognition.onresult = function (n) {
                  ...
                  var o = n.results.length - 1,
                    a = n.results[o][0].transcript.trim(),
                    c = t(a),
                    s = "";
                  if (void 0 !== c)
