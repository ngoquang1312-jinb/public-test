...
!(function (e, n) {
  "object" === typeof exports && "object" === typeof module
    ...
    ? define("ActiveIntent", [], n)
    : "object" === typeof exports
    ? (exports.ActiveIntent = n())
    : (e.ActiveIntent = n());
})(this, function () {
  return (function (e) {
    var n = {};
    ...
    function (e, n) {
      function compareTwoStrings(e, n) {
        if ((e = e.replace(/\s+/g, "")) === (n = n.replace(/\s+/g, "")))
          return 1;
        if (e.length < 2 || n.length < 2) return 0;
        for (var t = new Map(), r = 0; r < e.length - 1; r++) {
          var o = e.substring(r, r + 2),
            i = t.has(o) ? t.get(o) + 1 : 1;
          t.set(o, i);
        }
        for (var c = 0, a = 0; a < n.length - 1; a++) {
          var A = n.substring(a, a + 2),
            s = t.has(A) ? t.get(A) : 0;
          s > 0 && (t.set(A, s - 1), c++);
        }
        return (2 * c) / (e.length + n.length - 2);
      }
      e.exports = {
        ...
        findBestMatch: function (e, n) {
          ...
          for (var t = [], r = 0, o = 0; o < n.length; o++) {
            var i = n[o],
              c = compareTwoStrings(e, i);
            t.push({ target: i, rating: c }), c > t[r].rating && (r = o);
          }
          var a = t[r];
          return { ratings: t, bestMatch: a, bestMatchIndex: r };
        },
      };
    },
    function (e, n, t) {
        ...
        o = function App(e) {
          ...
          !(function (e, n) {
            ...
            _defineProperty(this, "usingSDKRequest", function () {
              ...
              n.recognition &&
                (n.configureRecognition(), n.addMicrophoneElement()),
                n.addSpeakerElements(),
                n.addListener();
            }),
            _defineProperty(this, "findTheIntent", function (e) {
              var t,
                r = _createForOfIteratorHelper(n.intents);
              try {
                for (r.s(); !(t = r.n()).done; ) {
                  var o = t.value;
                  if (o.phrases.includes(e)) return o;
                  var i,
                    c = _createForOfIteratorHelper(o.phrases);
                  try {
                    for (c.s(); !(i = c.n()).done; ) {
                      var a = i.value;
                      if (e.startsWith(a)) return o;
                    }
                  } catch (A) {
                    c.e(A);
                  } finally {
            ...
            _defineProperty(this, "configureRecognition", function () {
              ...
              (n.recognition.onstart = function () {
                ...
                (n.recognition.onnomatch = function () {
                  console.log(
                    "GI\u1eccNG N\xd3I KH\xd4NG \u0110\u01af\u1ee2C NH\u1eacN D\u1ea0NG"
                  );
                }),
                (n.recognition.onresult = function (n) {
                  var o = n.results.length - 1,
                    i = n.results[o][0].transcript.trim(),
                    c = t(i),
                    a = "";
                  if (void 0 !== c)
                    if (((e = c), "ArticleIntent" === c.name)) {
                      ...
                      null !== s && void 0 !== s && (a = s.textContent.trim());
                    }
                  else if (
                    void 0 === c &&
                    void 0 !== e &&
                  ...
                  if (
                    ...
                    var d,
                      l = _createForOfIteratorHelper(c.phrases);
                    try {
                      for (l.s(); !(d = l.n()).done; ) {
                        var p = d.value;
                        i = i.replace(p, "");
                ...
                (n.recognition.onspeechend = function () {
                  console.log("KHI K\u1ebeT TH\xdaC C\xc2U N\xd3I");
                }),
                  ...
                  for (r.s(); !(t = r.n()).done; ) {
                    t.value.addEventListener("click", function () {
                      var n = document.querySelectorAll(
                        ".the_activeintent_permission.the_activeintent_display_none"
                      );
                      n.length > 0 &&
                        n[0].classList.remove("the_activeintent_display_none"),
