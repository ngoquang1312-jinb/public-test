            ...
            _defineProperty(this, "configureRecognition", function () {
              ...
              (n.recognition.onstart = function () {
                ...
                (n.recognition.onresult = function (n) {
                  a = 0;
                  var i = n.results.length - 1,
                    o = n.results[i][0].transcript.trim(),
                    c = t(o),
                    s = "";
                  if (void 0 !== c)
                ...
                for (n.s(); !(e = n.n()).done; ) {
                  var t = e.value,
                    r = document.getElementsByClassName(
                      "the_activeintent_next"
                    );
                  if (r && r.length > 0)
                    console.log(r, 12121221),
                      (r[0].innerHTML =
